...
public final class RouteServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<route.Route,
      route.RouteSummary> getRecordRouteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RecordRoute",
      requestType = route.Route.class,
      responseType = route.RouteSummary.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<route.Route,
      route.RouteSummary> getRecordRouteMethod() {
    io.grpc.MethodDescriptor<route.Route, route.RouteSummary> getRecordRouteMethod;
    if ((getRecordRouteMethod = RouteServiceGrpc.getRecordRouteMethod) == null) {
      synchronized (RouteServiceGrpc.class) {
        if ((getRecordRouteMethod = RouteServiceGrpc.getRecordRouteMethod) == null) {
          RouteServiceGrpc.getRecordRouteMethod = getRecordRouteMethod =
              io.grpc.MethodDescriptor.<route.Route, route.RouteSummary>newBuilder()
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  route.Route.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  route.RouteSummary.getDefaultInstance()))
              .setSchemaDescriptor(new RouteServiceMethodDescriptorSupplier("RecordRoute"))
              .build();
        }
      }
    }
  ...
  public static abstract class RouteServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<route.Route> recordRoute(
        io.grpc.stub.StreamObserver<route.RouteSummary> responseObserver) {
