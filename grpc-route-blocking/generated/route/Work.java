...
/**
 * Protobuf type {@code route.Work}
 */
public final class Work extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:route.Work)
    WorkOrBuilder {
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return route.RouteOuterClass.internal_static_route_Work_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return route.RouteOuterClass.internal_static_route_Work_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            route.Work.class, route.Work.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof route.Work)) {
      return super.equals(obj);
    }
    route.Work other = (route.Work) obj;
  ...
  public static route.Work parseFrom(
  ...
  public static route.Work parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static route.Work parseFrom(
  ...
  public static route.Work parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static route.Work parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static route.Work parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(route.Work prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:route.Work)
      route.WorkOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return route.RouteOuterClass.internal_static_route_Work_descriptor;
    ...
    // Construct using route.Work.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public route.Work getDefaultInstanceForType() {
      return route.Work.getDefaultInstance();
    }

    @java.lang.Override
    public route.Work build() {
      route.Work result = buildPartial();
    ...
    @java.lang.Override
    public route.Work buildPartial() {
      route.Work result = new route.Work(this);
      result.id_ = id_;
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof route.Work) {
        return mergeFrom((route.Work)other);
      } else {
    ...
    public Builder mergeFrom(route.Work other) {
      if (other == route.Work.getDefaultInstance()) return this;
      if (other.getId() != 0L) {
        setId(other.getId());
      }
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      route.Work parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (route.Work) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    // @@protoc_insertion_point(builder_scope:route.Work)
  }

  // @@protoc_insertion_point(class_scope:route.Work)
  private static final route.Work DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new route.Work();
  }

  public static route.Work getDefaultInstance() {
